		...
		if(btn.getText().equals("Add"))
			{
				...
				else
				{
					...
					try{
						...
						st.executeUpdate("update Records set Name='"+name+"'where id="+modi.r);	
						st.executeUpdate("update Records set Chemistry="+b+" where id="+modi.r);
						st.executeUpdate("update Records set Physics="+c+" where id="+modi.r);
						st.executeUpdate("update Records set Maths="+d+" where id="+modi.r);				
						st.executeUpdate("update Records set PS="+e+" where id="+modi.r);
						st.executeUpdate("update Records set Biology="+f+" where id="+modi.r);
						st.executeUpdate("update Records set ID="+a+" where id="+modi.r);
						con.close();
						st.close();
